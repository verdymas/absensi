...
@section('content')
    ...
    <section id="one" class="spotlight style1 bottom">
        <span class="image fit main"><img src="/dua/images/pic02.jpg" alt="" /></span>
        <div class="content">
            <div class="container">
                <div class="row">
    ...
    <section id="two" class="spotlight style2 right">
        <span class="image fit main"><img src="/dua/images/pic03.jpg" alt="" /></span>
        <div class="content">
            <header>
    ...
    <section id="three" class="spotlight style3 left">
        <span class="image fit main bottom"><img src="/dua/images/pic04.jpg" alt="" /></span>
        <div class="content">
            <header>
